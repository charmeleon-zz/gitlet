...
var originalDateToStsing = Date.prototype.toString;

var testUtil = module.exports = {
  /**
   * Test that a file's contents match the given string.
   *
   * @param path
   * @param content
   */
  ...
  /**
   * Creates files/directories from JSON object outlining a tree structure
   *
   * @param structure
   * @param prefix
   */
  ...
  unpinDate: function() {
    global.Date.prototype.toString = originalDateToStsing;
  },
